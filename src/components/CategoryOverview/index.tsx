  ...
  return (
    <div className='flex flex-col gap-10 md:gap-5'>
        ...
        <div className='flex flex-col gap-8'>
            <p className='text-[30px] md:text-[20px] font-semibold text-center text-primary'>{header}</p>
            <p className='text-[20px]  m-auto text-center w-2/3 md:w-[90%] md:text-[15px]'>{description}</p>
